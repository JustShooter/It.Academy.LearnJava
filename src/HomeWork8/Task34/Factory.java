...
public class Factory {
    private int factoryIncome = 2600000; // Доход завода
    private int hourlyRate = 12; // Почасавой тариф
    private double tax = 16;
    private int wageFund = factoryIncome - (int) (factoryIncome / 100 * tax); // фонд оплаты труда (доход завода - %налога)
